...
| Typescript | C#                 | Bash       | GraphQL        | Oracle    | Docker    | StreamSets | Azure DevOps | TFVC | MS Dynamics       |
| Angular    | .NET 5, 6          | Python     | LINQ           | Snowflake | Heroku    | Alteryx    | GitLab       | SVN  | Camunda           |
| React      | .NET Framework 4.x | VBS        | MQL            | DynamoDB  | SCCM      |            | GitHub       |      | Workday           |
| MaterialUI | ASP.NET            | Batch      |                | MongoDB   | RabbitMQ  |            |              |      | Encompass         |
# Education
